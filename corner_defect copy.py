...
def defect3to6(base_img, base_img_name, defect_img, defect_img_data):
    ...
    if not "_CAM3" in defect_img_data["name"]: 
        ...
        # cv2.imwrite("base_bg.jpg",base_bg)
        # cv2.imwrite("defect_img.jpg",defect_img)
        # cv2.imwrite("result.jpg",result)
        # cv2.imwrite("base_bg_mask.jpg",base_bg_mask)
...
if __name__ == "__main__":
    ...
    if not os.path.exists("gen_train_annos_demo.json"):
        with open("gen_train_annos_demo.json", "w") as wnfile:
            json.dump([], wnfile)

    with open("data.json", 'r') as f:
        img_data = json.load(f)

    with open("gen_train_annos_demo.json", "r") as rnfile:
    ...
    for base_img_name in base_imgs:
        ...
        for defect_img_data in tqdm(img_data):
            # if defect_img_data["name"]!="251_121_t20201129154340925_CAM2.jpg": continue
            defect_img_name = defect_img_data["name"]
            gen_img = None
            ...
            if gen_img is not None:
                cv2.rectangle(gen_img, (gen_img_inf["bbox"][0], gen_img_inf["bbox"][1]), (gen_img_inf["bbox"][2], gen_img_inf["bbox"][3]), (0, 0, 255), 3)
                if gen_img_inf["category"] == 1 and base_img_name[base_img_name.index("_CAM"):]=="_CAM1.jpg":
                    output_folder = "demo_output/1/_CAM1"
                elif gen_img_inf["category"] == 1 and base_img_name[base_img_name.index("_CAM"):]=="_CAM2.jpg":
                    output_folder = "demo_output/1/_CAM2"
                elif gen_img_inf["category"] == 1 and base_img_name[base_img_name.index("_CAM"):]=="_CAM3.jpg":
                    output_folder = "demo_output/1/_CAM3"
                elif gen_img_inf["category"] == 2 and base_img_name[base_img_name.index("_CAM"):]=="_CAM1.jpg":
                    output_folder = "demo_output/2/_CAM1"
                elif gen_img_inf["category"] == 2 and base_img_name[base_img_name.index("_CAM"):]=="_CAM2.jpg":
                    output_folder = "demo_output/2/_CAM2"
                elif gen_img_inf["category"] == 2 and base_img_name[base_img_name.index("_CAM"):]=="_CAM3.jpg":
                    output_folder = "demo_output/2/_CAM3"
                elif gen_img_inf["category"] == 3 and base_img_name[base_img_name.index("_CAM"):]=="_CAM1.jpg":
                    output_folder = "demo_output/3/_CAM1"
                elif gen_img_inf["category"] == 3 and base_img_name[base_img_name.index("_CAM"):]=="_CAM2.jpg":
                    output_folder = "demo_output/3/_CAM2"
                elif gen_img_inf["category"] == 3 and base_img_name[base_img_name.index("_CAM"):]=="_CAM3.jpg":
                    output_folder = "demo_output/3/_CAM3"
                elif gen_img_inf["category"] == 4 and base_img_name[base_img_name.index("_CAM"):]=="_CAM1.jpg":
                    output_folder = "demo_output/4/_CAM1"
                elif gen_img_inf["category"] == 4 and base_img_name[base_img_name.index("_CAM"):]=="_CAM2.jpg":
                    output_folder = "demo_output/4/_CAM2"
                elif gen_img_inf["category"] == 4 and base_img_name[base_img_name.index("_CAM"):]=="_CAM3.jpg":
                    output_folder = "demo_output/4/_CAM3"
                elif gen_img_inf["category"] == 5 and base_img_name[base_img_name.index("_CAM"):]=="_CAM1.jpg":
                    output_folder = "demo_output/5/_CAM1"
                elif gen_img_inf["category"] == 5 and base_img_name[base_img_name.index("_CAM"):]=="_CAM2.jpg":
                    output_folder = "demo_output/5/_CAM2"
                elif gen_img_inf["category"] == 5 and base_img_name[base_img_name.index("_CAM"):]=="_CAM3.jpg":
                    output_folder = "demo_output/5/_CAM3"
                elif gen_img_inf["category"] == 6 and base_img_name[base_img_name.index("_CAM"):]=="_CAM1.jpg":
                    output_folder = "demo_output/6/_CAM1"
                elif gen_img_inf["category"] == 6 and base_img_name[base_img_name.index("_CAM"):]=="_CAM2.jpg":
                    output_folder = "demo_output/6/_CAM2"
                elif gen_img_inf["category"] == 6 and base_img_name[base_img_name.index("_CAM"):]=="_CAM3.jpg":
                    output_folder = "demo_output/6/_CAM3"
